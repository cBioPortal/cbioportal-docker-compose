...
echo db.user=cbio_user >> portal.properties
echo db.password=somepassword >> portal.properties
echo db.driver=com.mysql.jdbc.Driver >> portal.properties
echo 'db.connection_string=jdbc:mysql://cbioportal-database:3306/cbioportal?useSSL=false&allowPublicKeyRetrieval=true' >> portal.properties
